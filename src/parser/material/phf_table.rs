...
pub static MATERIAL_PROPERTY_TOKENS: phf::Map<&'static str, MaterialProperty> = phf::phf_map! {
    ...
    "STATE_ADJ" => MaterialProperty::StateAdj,
    "STATE_NAME_ADJ" => MaterialProperty::StateNameAdj,
