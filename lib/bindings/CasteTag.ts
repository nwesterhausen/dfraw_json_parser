...
export type CasteTag =
  ...
  | "AmbushPredator"
  | "Amphibious"
  | { ApplyCreatureVariation: { id: string; args: Array<string> } }
  ...
  | "BloodSucker"
  | { Body: { body_parts: Array<string> } }
  | { BodyAppearanceModifier: { attribute: string; values: Array<number> } }
  | { BodyDetailPlan: { body_plan: string; arguments: Array<string> } }
  | { BodySize: { year: number; days: number; size: number } }
  | { BodyGloss: { gloss: string } }
  | "BoneCarn"
  | { BodyPartAddType: { body_part_type: string } }
  | { BodyPartAppearanceModifier: { quality: string; spread: Array<number> } }
  ...
  | { EggSize: { size: number } }
  | "Equips"
  | { ExtraButcherObject: { object_type: string; arguments: Array<string> } }
  ...
  | "Immolate"
  | "Intelligent"
  | { InteractionDetail: { args: Array<string> } }
  ...
  | { MentalAttributeRange: { attribute: string; ranges: Array<number> } }
  | {
      MentalAttributeRate: {
        attribute: string;
  ...
  | { PhysicalAttributeRange: { attribute: string; ranges: Array<number> } }
  | {
