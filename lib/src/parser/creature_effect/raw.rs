...
impl CreatureEffect {
    ...
    pub fn cleaned(&self) -> Self {
        ...
        // Set any empty string to None.
        if let Some(affected_body_parts_by_category) = cleaned.affected_body_parts_by_category {
        ...
        // Set any empty string to None.
        if let Some(affected_body_parts_by_type) = cleaned.affected_body_parts_by_type {
        ...
        // Set any empty string to None.
        if let Some(affected_body_parts_by_token) = cleaned.affected_body_parts_by_token {
